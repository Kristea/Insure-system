...
<html>
    ...
    <body>
        ...
        <div class="nav-bar">
            <div class="container">
                <ul class="nav">
                    <li><a href="OverviewPage_Insurer.jsp">Overview</a></li>
                    <li><a href="AddRiskThreshold.jsp">Add Risk Threshold</a></li>
        ...
        <div class="content">
            <div class="container">
                <div class ="main">
                    ...
                    <h1>Welcome  ${insurer.title} ${insurer.fName} ${insurer.sName} !</h1>
